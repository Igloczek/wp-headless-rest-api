...
class UrlToQuery {
    ...
    /**
     * Array of the instantiated UrlToQueryItem objects
     * @var array
     */
    private $items = [ ];
...
class UrlToQueryItem {
     ...
     * @param array $rewrite
     * @return array
     * @uses UrlToQueryItem::parseRewriteRule()
     */
     ...
     *
     * @return array
     * @uses UrlToQueryItem::parseQueryVars()
     * @uses UrlToQueryItem::parseTaxQueryVars()
     * @uses UrlToQueryItem::parseCptQueryVars()
     * @uses UrlToQueryItem::parsePrivateQueryVars()
     */
     ...
     * @param array $extra
     * @uses UrlToQueryItem::parseQueryVar()
     */
